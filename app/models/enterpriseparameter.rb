...
class Enterpriseparameter < ActiveRecord::Base

  belongs_to :enterprise
  
  attr_accessible :enterprise_id, :daily_salary_rate, :hourly_salary_rate, :ot_multiplier_1, :ot_multiplier_2, :ot_multiplier_3,
