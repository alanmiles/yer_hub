...
class Enterprise < ActiveRecord::Base
  ...
  attr_accessible :name, :short_name, :address_1, :address_2, :address_3, :town, :district, :zipcode, :country_id,
  		  :home_airport, :sector_id, :mission, :values, :terms_accepted, :setup_step, :inactive
